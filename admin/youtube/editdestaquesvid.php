...
<body>
    ...
    <section class="artigos container d-flex justify-content-center align-items-center flex-column">
        <h1 class="mt-5">Você pode escolher até 53 destaques</h1>
        <h2>Esses são seus videos em destaque!</h2>
                ...
                <div clas="d-flex justify-content-between  ">
                    ...
                    while ($dado = $con->fetch_array()) { ?>
                        <div style="height: 30px;" class="d-flex justify-content-between align-flex-end">
                            <?php echo $dado['titulo'] ?> <br>
                            <a href="proc_rem_video.php?id=<?php echo $dado['id'] ?>"><button class="removerbutton ml-lg-5">Remover</button></a>
                        </div>
                    <?php }
    ...
    <section class="artigos container d-flex justify-content-center align-items-center flex-column">
        <h1 class="mt-5">Basta Clicar para destacar o video :)</h1>
        <div class="container justify-content-center align-items-center d-flex flex-lg-row flex-column ">
...
$result_busca = "SELECT * FROM youtube where destaque like 0";
$resultado = mysqli_query($connect, $result_busca);
$con = $connect->query($result_busca) or die($mysqli->error);
/* LENDO DADOS DO BANCO DE DADOS */
  while($dado = $con->fetch_array()) { ?>
        <div class="cardvideo mr-4">
                <a href="proc_add_video.php?id=<?php echo $dado['id'] ?>"> <img src="../../youtube/<?php echo $dado['tumb'] ?>" alt="">

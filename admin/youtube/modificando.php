...
$result_busca = "SELECT * FROM doutor where id like $id ";
...
<body>
    ...
    <section class="artigos container d-flex justify-content-center align-items-center flex-column">
        <h1 class="mt-5">Você tem certeza que quer remover este video ?</h1>
    ...
    align-items: center;
    display: flex;"class="btn-enviar mt-3"href="proc_del_video.php?id=<?php echo $id?>">Excluir Artigo</a>           
